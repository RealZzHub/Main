...
function RealZzLib:CreateMain(GameName)
	...
	function TabLibrary:NewTab(TabName)
		...
		function MainLibrary:NewDropdown(DropdownName, ItemList, callback)
			...
			for i, v in pairs(ItemList) do
				...
				DropdownButton.MouseButton1Click:Connect(function()
					pcall(callback, DropdownButton.Text)
					Dcloseopen()
				end)
		...
		function MainLibrary:NewColorPicker(ColorPickerName, callback, PresetColor, IsRainbow) --fucked up by me 0x44 cuz i cant make color pickers
